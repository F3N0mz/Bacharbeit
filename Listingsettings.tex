...
\definecolor{vscBlue}{RGB}{0, 0, 205}         % keywords
\definecolor{vscDarkCyan}{RGB}{0, 128, 128}   % functions
\definecolor{vscGray}{RGB}{100, 100, 100}     % comments
\definecolor{vscString}{RGB}{163, 21, 21}     % strings
\definecolor{vscNumber}{RGB}{0, 128, 0}       % numeric constants
...
\lstdefinestyle{cppstyle}{
	...
	commentstyle=\color{vscGray}\itshape,
	...
	captionpos=b,
	morekeywords={MotorStatus, setup, loop},
	emph={Serial, motorSetup, bleSetup, bleLoop, motorLoop, bleNotifyDispenseComplete},
	emphstyle=\color{vscDarkCyan}
}

% Custom colors (VSCode-style)
